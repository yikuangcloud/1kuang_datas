...
@RestController
@RequestMapping("/chart/BI/progress")
public class ChartProgressBIController {
    ...
    public AjaxResult analysis(@RequestBody ChartDBInfo chartDBInfo) {
        ...
        JSONArray arr = null;
		List<JSONObject> pros = new ArrayList<>();
        try {
            ...
            if(!arr.isEmpty()){
	            ...
	            for (int i = 0; i < coordinateList.size(); i++) {
	    			...
	    			pro.put("value", Float.parseFloat(value.toString()) );
	    			pro.put("name", coordinateList.get(i));
        ...
        return AjaxResult.success(pros);
    }
}
