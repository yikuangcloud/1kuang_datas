...
@RestController
@RequestMapping("/chart/BI/barpie")
public class ChartBarPieBIController {
    ...
    public AjaxResult analysis(@RequestBody ChartDBInfo chartDBInfo) {
        ...
        JSONArray arr = null;
		List<JSONObject> barpies = new ArrayList<>();
        try {
            ...
            if(!arr.isEmpty()){
                ...
                for (int i = 0; i < coordinateList.size(); i++) {
        			...
        			JSONObject barpie = new JSONObject();
        			Object value = object.get(coordinateList.get(i)) != null ? object.get(coordinateList.get(i)):0;
        			
        			barpie.put("value", Float.parseFloat(value.toString()) );
        			barpie.put("name", coordinateList.get(i));
        ...
        return AjaxResult.success(barpies);
    }
}
